...
export default function LiftPlanning() {
  return (
    <div className="container mx-auto px-4 py-16 space-y-16">
      <SEO
        title="Lift Planning Services | SRLS Ltd. Trinidad"
        description="Professional lift planning services from certified riggers. SRLS Ltd. provides detailed lift studies, risk assessments, and method statements in Trinidad."
        canonical="https://safetyriggingandliftingconsultancy.com/services/lift-planning"
      />
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto">
          <MotionWrapper className="max-w-4xl mx-auto text-center space-y-8 block">
